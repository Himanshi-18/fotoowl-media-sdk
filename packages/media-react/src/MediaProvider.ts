...
/**
 * Provides a single `MediaCore` instance to the React tree. Pass a
 * pre-built `client` (e.g. shared across React and React Native), or a
 * `config` and let the provider construct + memoize the instance.
 *
